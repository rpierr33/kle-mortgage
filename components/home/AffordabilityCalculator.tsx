...
export function AffordabilityCalculator() {
  ...
  const intlLocale = localeToBcp47[locale] || "en-US";
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      inputMode="numeric"
                      value={incomeInput ? parseInt(incomeInput, 10).toLocaleString(intlLocale) : ""}
            ...
            <div className="px-8 py-10 md:px-12">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="md:col-span-1 bg-[#6B1C23] rounded-2xl p-6 text-center">
                  ...
                  <div className="text-white/40 text-xs mt-1">{t("maxPriceHint")}</div>
                </div>
                ...
                <div className="bg-[#FAF8F5] border border-[#E8E0D8] rounded-2xl p-6 text-center">
                  ...
                  <div className="text-[#9CA3AF] text-xs mt-1">{t("downPaymentHint")}</div>
                </div>
                ...
                <div className="bg-[#FAF8F5] border border-[#E8E0D8] rounded-2xl p-6 text-center">
                  ...
                  <div className="text-[#9CA3AF] text-xs mt-1">{t("monthlyHint")}</div>
                </div>
              </div>
