...
const realTeam = [
  {
    ...
    bio: "Founded Leo Realty Capital Investments in 1992. Brings 36+ years of South Florida market expertise to mortgage lending and investment financing.",
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {displayOfficers.map((officer, idx) => {
            type MemberKey = `${typeof officer.slug}.${"title" | "bio" | "specialty1" | "specialty2" | "specialty3"}`;
            const tm = (suffix: "title" | "bio" | "specialty1" | "specialty2" | "specialty3") =>
              tMembers(`${officer.slug}.${suffix}` as MemberKey);
            const memberTitle = tm("title");
            const memberBio = tm("bio");
            const specialties = [tm("specialty1"), tm("specialty2"), tm("specialty3")];
            return (
              <motion.div
                key={officer.id}
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <p className="text-xs text-[#C9A345] font-semibold mb-1 tracking-wide">{memberTitle}</p>
                  {officer.nmlsNumber && (
