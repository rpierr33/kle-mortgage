      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-sm text-[#6B6056] max-w-sm mx-auto leading-relaxed">
            Adjust the sliders to see your estimated monthly payment instantly.
          </p>
        </motion.div>

        {/* Calculator card — single column */}
        <motion.div
        ...
        >
          ...
          <div className="bg-gradient-to-br from-[#6B1C23] via-[#7A1E26] to-[#4A1218] p-8 sm:p-10 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="text-white/55 text-xs tracking-wider uppercase mb-2">Estimated Monthly Payment</p>
              <p
