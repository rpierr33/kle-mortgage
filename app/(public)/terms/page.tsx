    ...
    <section className="pt-28 pb-20 bg-[#F8F6F3]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl border border-[#E8E0D8] p-8 sm:p-12 space-y-6 text-[#6B6056] leading-relaxed">
          ...
          <div>
            <h2 className="text-xl font-bold text-[#1A1A1A] mb-2 font-[family-name:var(--font-playfair)]">Not a Commitment to Lend</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-[#1A1A1A] mb-2 font-[family-name:var(--font-playfair)]">Calculator Disclaimer</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-[#1A1A1A] mb-2 font-[family-name:var(--font-playfair)]">Equal Housing Lender</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-[#1A1A1A] mb-2 font-[family-name:var(--font-playfair)]">Licensing</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-[#1A1A1A] mb-2 font-[family-name:var(--font-playfair)]">Contact</h2>
