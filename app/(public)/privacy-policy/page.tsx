    ...
    <section className="pt-28 pb-20 bg-[#F8F6F3]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl border border-[#E8E0D8] p-8 sm:p-12 prose prose-slate max-w-none">
          ...
          <h2 className="text-xl font-bold text-[#1A1A1A] mt-8 mb-3 font-[family-name:var(--font-cormorant)]">Information We Collect</h2>
          ...
          <h2 className="text-xl font-bold text-[#1A1A1A] mt-8 mb-3 font-[family-name:var(--font-cormorant)]">How We Use Your Information</h2>
          ...
          <h2 className="text-xl font-bold text-[#1A1A1A] mt-8 mb-3 font-[family-name:var(--font-cormorant)]">Information Sharing</h2>
          ...
          <h2 className="text-xl font-bold text-[#1A1A1A] mt-8 mb-3 font-[family-name:var(--font-cormorant)]">Contact Us</h2>
