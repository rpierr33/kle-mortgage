      ...
      <section className="pt-28 pb-20 bg-[#6B1C23] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              Mortgage Tips{" "}
              <span className="text-[#C9A345] italic">&amp; Guides</span>
            </h1>
            <p className="text-lg text-white/75 leading-relaxed">
              Expert advice to help you navigate the homebuying and refinancing
            ...
            >
              {posts.map((post) => (
                <motion.div key={post.id} variants={cardVariant}>
                  ...
                  >
                    {/* Cover image placeholder — editorial accent */}
