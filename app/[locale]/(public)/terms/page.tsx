      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl border border-[#E8E0D8] p-8 sm:p-12 space-y-6 text-[#6B6056] leading-relaxed">
          ...
          <div>
            ...
            <p>KLE Mortgage Financing, LLC NMLS #2380070. Licensed to conduct mortgage business in Florida. NMLS Consumer Access: <a href="https://www.nmlsconsumeraccess.org" className="text-[#6B1C23] underline" target="_blank" rel="noopener noreferrer">nmlsconsumeraccess.org</a></p>
          </div>
